...
citHeader("To cite AugspurgerIndex in publications use:")

citEntry(
  entry    = "Miscellaneous",
  title    = 'AugspurgerIndex: Calculate Augspurgers Index of Synchrony',
...
An exciting possibility of this implementation of Augspurgers Index, and which warrants consideration for ephermal crepuscular or nocturnal species, is that it is able to operate on overlapping phenologies within a day, as recorded down to the second. 
